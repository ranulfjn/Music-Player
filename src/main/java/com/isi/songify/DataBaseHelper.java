...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public final static String DATABASE_PATH = "/data/data/com.isi.songify/databases/";
         ...
         ;
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    al_data.add(new CustomArrayList(id,img,title,artist));
